...
import pandas as pd
from synthetic import SynthesizerManager
...
def render():
    ...
    with st.sidebar:
        ...
        selected_synthesizer = st.selectbox("### Select Synthesizer", synthesizer_options)
    ...
    with st.expander("Data Input Methods", expanded=True):
        ...
        with col_sql:
            ...
            host = st.text_input("Host IP", value="localhost:3306")
            ...
            if table_type == "Single":
                ...
                if st.session_state.results:
                    ...
                    report_type = st.radio("Select Report Type", 
                                        ["Quality Report", "Column Plots", "Pair Plots"], horizontal=True)
                    ...
                    if report_type == "Quality Report":
                        ...
                        if 'pair_plots' in st.session_state.results['reports']:
                            ...
                            selected_pair = st.selectbox("Select Column Pair", pair_options)
                ...
                if st.session_state.results:
                    ...
                    report_type = st.radio("Select Report Type", 
                                        ["Quality Report", "Column Plots", "Pair Plots"], 
                                        horizontal=True,
                                        key="multi_report_type")
